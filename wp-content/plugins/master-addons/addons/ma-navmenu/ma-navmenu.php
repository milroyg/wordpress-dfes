    ...
    protected function jltma_nav_menu_general_section()
    {
        ...
        $this->add_control(
            ...
            array(
                ...
                'description'        => Master_Addons_Helper::upgrade_to_pro('Dropdown Layout available on'),
            )
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => Master_Addons_Helper::upgrade_to_pro('Dropdown Types available on'),
            ]
        );
