	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'style_transfer' => true,
				'description'    => Master_Addons_Helper::upgrade_to_pro('2+ more Handle Options on'),
			]
		);
		...
		$border_radius_controls = apply_filters('master_addons/addons/image_comparison/border_radius', [
			[
				...
				'args'       => [
					...
					'default'     => '1',
					'description' => Master_Addons_Helper::upgrade_to_pro('Border Radius on'),
				],
			],
			[
				'type'       => 'responsive_control',
				...
				'args'       => [
					...
					'default'     => '1',
					'description' => Master_Addons_Helper::upgrade_to_pro('Box Shadow on'),
				],
			],
		]);
