	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'description'        => Master_Addons_Helper::upgrade_to_pro('3+ more Variations on'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'description' => Master_Addons_Helper::upgrade_to_pro('4+ more Circle Variations on'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'description' => Master_Addons_Helper::upgrade_to_pro('More Animated Variations on'),
			]
		);
