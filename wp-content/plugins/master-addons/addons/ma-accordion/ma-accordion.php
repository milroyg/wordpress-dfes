		...
		$single_tab_styling_controls = apply_filters('master_addons/addons/accordion/single_tab_styling', [
			[
				...
				'args' => [
					...
					'default' => '1',
					'description' => Master_Addons_Helper::upgrade_to_pro('Single Tab Styling available on'),
				],
			],
		]);
						...
						<<?php echo esc_html($title_html_tag); ?> <?php echo $this->get_render_attribute_string($tab_title_setting_key);
							...
							<div class="jltma-accordion-title-icon">
								...
								<div class="jltma-accordion-title-text">
									<?php echo $this->parse_text_editor(Master_Addons_Helper::wp_kses_custom($tab['tab_title'])); ?>
								</div>
							</div>
