	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'description' => Master_Addons_Helper::upgrade_to_pro('20+ more effects on'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => 'content',
				'description' => Master_Addons_Helper::upgrade_to_pro('Popup Content Types on'),
				'condition'   => [
		...
		$image_styling_controls = apply_filters('master_addons/addons/image_hover_effects/image_styling', [
			[
				...
				'args'       => [
					...
					'default'     => '1',
					'description' => Master_Addons_Helper::upgrade_to_pro('Border Radius available on'),
				],
			],
			[
				'type'       => 'responsive_control',
				...
				'args'       => [
					...
					'default'     => '1',
					'description' => Master_Addons_Helper::upgrade_to_pro('Padding available on'),
				],
			],
			[
				'type'       => 'responsive_control',
				...
				'args'       => [
					...
					'default'     => '1',
					'description' => Master_Addons_Helper::upgrade_to_pro('Margin available on'),
				],
			],
		]);
