...
class JLTMA_Creative_Button extends Widget_Base {
    ...
    public function get_style_depends() {
        return ['ma-creative-buttons', 'font-awesome-5-all', 'font-awesome-4-shim'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section( 'ma_el_creative_button_content_style_presets', [
            'label' => esc_html__( 'Style Presets', 'master-addons' ),
        ] );
        $this->add_control( 'creative_button_effect', [
            ...
            'description' => sprintf( '15+ more Variations on <a href="%s" target="_blank">%s</a>', esc_url_raw( admin_url( 'admin.php?page=master-addons-settings-pricing' ) ), __( 'Upgrade Now', 'master-addons' ) ),
        ] );
        $this->add_responsive_control( 'ma_el_creative_button_alignment', [
         ...
         */
        $this->start_controls_section( 'ma_el_creative_button_content', [
            'label' => esc_html__( 'Button Controls', 'master-addons' ),
        ] );
        $this->add_control( 'creative_button_text', [
        ...
        $this->add_control( 'creative_alternative_button_text', [
        ...
        $this->add_control( 'creative_button_link_url', [
        ...
        $this->add_control( 'ma_el_creative_button_icon_indent', [
         ...
         */
        $this->start_controls_section( 'ma_el_creative_button_settings', [
            'label' => esc_html__( 'Button Styles', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_responsive_control( 'ma_el_creative_button_width', [
        ...
        $this->add_responsive_control( 'ma_el_creative_button_padding', [
        ...
        $this->add_control( 'ma_el_creative_button_text_color', [
        ...
        $this->add_control( 'ma_el_creative_button_icon_color', [
        ...
        $this->add_control( 'ma_el_creative_button_icon_size', [
        ...
        $this->add_control( 'ma_el_creative_button_background_color', [
        ...
        $this->add_control( 'ma_el_creative_button_before_background_color', [
        ...
        $this->add_control( 'ma_el_creative_button_after_background_color', [
        ...
        $this->add_control( 'ma_el_creative_button_border_radius', [
        ...
        $this->add_control( 'ma_el_creative_button_before_border_color', [
            ...
            'condition' => [
                'creative_button_effect' => ['jltma-creative-button--wapasha', 'jltma-creative-button--antiman'],
            ],
        ] );
        ...
        $this->add_control( 'ma_el_creative_button_hover_text_color', [
            'label'     => esc_html__( 'Text Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#ffffff',
            'selectors' => [
        ...
        $this->add_control( 'ma_el_creative_button_hover_background_color', [
            'label'     => esc_html__( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#f54',
            'selectors' => [
        ...
        $this->add_control( 'ma_el_creative_button_before_hover_background_color', [
            'label'     => esc_html__( 'Before BG Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#7986cb',
            'selectors' => [
            ...
            'condition' => [
                'creative_button_effect' => ['jltma-creative-button--nuka'],
            ],
        ] );
        $this->add_control( 'ma_el_creative_button_before_hover_after_background_color', [
            'label'     => esc_html__( 'After BG Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#7986cb',
            'selectors' => [
        ...
        $this->add_control( 'ma_el_creative_button_hover_after_background_color', [
            'label'     => esc_html__( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#f54',
            'selectors' => [
        ...
        $this->add_control( 'ma_el_creative_button_hover_border_color', [
    ...
    protected function render() {
		...
		<div class="jltma-creative-button-wrapper">
			<a <?php 
        echo $this->get_render_attribute_string( 'ma_el_creative_button' );
        ?>>
				<span>
					<?php 
        if ( !empty( $settings['ma_el_creative_button_icon'] ) && $settings['ma_el_creative_button_icon_alignment'] == 'left' ) {
            $migrated = isset( $settings['__fa4_migrated']['ma_el_creative_button_icon'] );
            $is_new = empty( $settings['icon'] ) && \Elementor\Icons_Manager::is_migration_allowed();
            if ( $is_new || $migrated ) {
                \Elementor\Icons_Manager::render_icon( $settings['ma_el_creative_button_icon'], [
                    'aria-hidden' => 'true',
                    'class'       => 'jltma-creative-button-icon-left',
                ] );
            } else {
                ?>
                            <i class="jltma-creative-button-icon-left <?php 
        ...
        if ( !empty( $settings['ma_el_creative_button_icon'] ) && $settings['ma_el_creative_button_icon_alignment'] == 'right' ) {
            ...
            if ( $is_new || $migrated ) {
                \Elementor\Icons_Manager::render_icon( $settings['ma_el_creative_button_icon'], [
                    'aria-hidden' => 'true',
                    'class'       => 'jltma-creative-button-icon-right',
                ] );
            } else {
                ?>
                                <i class="jltma-creative-button-icon-right <?php 
                echo esc_attr( $settings['icon'] );
                ?>" aria-hidden="true"></i>
                            <?php 
            }
