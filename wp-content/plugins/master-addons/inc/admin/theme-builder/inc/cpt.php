...
class Master_Addons_CPT{
    ...
    public function jltma_register_post_type() {
        ...
        $labels = array(
            'name'               => esc_html__( 'Theme Builder', 'master-addons' ),
            'singular_name'      => esc_html__( 'Theme Builder', 'master-addons' ),
            'menu_name'          => esc_html__( 'Theme Builder', 'master-addons' ),
            'name_admin_bar'     => esc_html__( 'Theme Builder', 'master-addons' ),
    ...
    public function jltma_cpt_menu(){
        add_submenu_page(
            ...
            esc_html__('Theme Builder', 'master-addons' ),
            esc_html__('Theme Builder', 'master-addons' ),
            'manage_options',
