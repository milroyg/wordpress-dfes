<div class="jltma-pop-contents-body" id="jltma_hf_modal_body">
    ...
    <div class="jltma-pop-contents-padding">
        <form action="" mathod="get" id="jltma_hf_modal_form" data-open-editor="0" data-editor-url="<?php 
echo get_admin_url();
?>" data-nonce="<?php 
                        ...
                        <div class="jltma-row">
                            ...
                            <div class="jltma-form-group mb-2 jltma-col-6">
                                <label for="jltma-mobile-submenu-type">
                                    <strong>
                                        <?php 
esc_html_e( 'Template Title', 'master-addons' );
?>
                                    </strong>
                                </label>
                            </div>
                            <div class="jltma-form-group mb-2 jltma-col-6">
                                <input required type="text" name="title" class="jltma_hf_modal-title jltma-form-control" placeholder="<?php 
echo esc_html__( 'Template Title here', 'master-addons' );
?>">
                            </div>
                            ...
                            <div class="jltma-form-group mb-2 jltma-col-6">
                                <label for="jltma-hf-trigger-effect">
                                    <strong>
                                        <?php 
esc_html_e( 'Template Type', 'master-addons' );
?>
                                    </strong>
                                </label>
                            </div>
...
?>
                                    ...
                                    <option value="footer">
                                        <?php 
esc_html_e( 'Footer', 'master-addons' );
?>
                                    </option>
...
?>
                            ...
                            <div class="jltma-form-group mb-2 jltma-col-6 jltma-hfc-hide-item-label">
                                <label for="jltma-hf-hide-item-label">
                                    <strong>
                                        <?php 
esc_html_e( 'Display Conditions', 'master-addons' );
?>
                                    </strong>
                                </label>
                            </div>
                            <div class="jltma-form-group mb-2 jltma-col-6 jltma_hf_options_container">
                                <select name="jltma_hf_conditions" class="jltma_hf_modal-jltma_hf_conditions jltma-form-control">
                                    <option value="entire_site">
                                        <?php 
esc_html_e( 'Entire Site', 'master-addons' );
?>
                                    </option>
...
esc_html_e( 'All Singulars', 'master-addons' );
?></option>
                                            <option value="front_page"><?php 
esc_html_e( 'Front Page', 'master-addons' );
?></option>
                                            <option value="all_posts"><?php 
esc_html_e( 'All Posts', 'master-addons' );
?></option>
                                            <option value="all_pages"><?php 
...
?>
            ...
            <div class="jltma-modal-footer">
                <button type="button" class="jltma-btn-editor jltma-save-btn jltma-color-three">
                    <img class="mr-1 mb-1" src="<?php 
echo JLTMA_IMAGE_DIR . 'icon.png';
?>" alt="Master Addons Logo">
                    <?php 
esc_html_e( 'Edit with Elementor', 'master-addons' );
?>
                </button>
                <button type="submit" class="jltma-hf-save jltma-save-btn jltma-color-two">
                    <?php 
esc_html_e( 'Save Settings', 'master-addons' );
?>
                </button>
            </div>
