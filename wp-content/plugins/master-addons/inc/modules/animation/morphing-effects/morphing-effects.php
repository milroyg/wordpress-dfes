...
if (!class_exists('MasterAddons\Modules\Morphing_Effects')) {
class Morphing_Effects extends Extension_Prototype
{
	...
	private function add_controls($element, $args)
	{
		...
		$element->add_control(
			...
			[
				'label' 				=> __('Morphing Effects', 'master-addons' ),
		...
		$element->add_control(
			...
			[
				'label' 		=> esc_html__('Blob Animation', 'master-addons' ),
				'type' 			=> Controls_Manager::SELECT,
				'options' 		=> [
					'jltma_blob_anim_01'	=> esc_html__('Effect One', 'master-addons' ),
					'animation_svg_02' 		=> esc_html__('Effect Two', 'master-addons' ),
					'animation_svg_03' 		=> esc_html__('Effect Three', 'master-addons' ),
					'animation_svg_04' 		=> esc_html__('Effect Four', 'master-addons' ),
					'animation_svg_05' 		=> esc_html__('Effect Five', 'master-addons' ),
				],
		...
		$element->add_control(
			...
			[
				'label' 		=> esc_html__('Blob Type', 'master-addons' ),
				'type' 			=> Controls_Manager::SELECT,
				'options' 		=> [
					'color'			=> esc_html__('Color', 'master-addons' ),
					'gradient'			=> esc_html__('Gradient', 'master-addons' ),
					'lottie' 		=> esc_html__('Lottie', 'master-addons' )
				],
				'default' 		=> 'gradient',
				'condition'     => [
					'jltma_morphing_effects_switch' => 'yes'
		...
		$element->add_control(
			...
			[
				'label' 		=> esc_html__('Blend Mode', 'master-addons' ),
				'type' 			=> Controls_Manager::SELECT,
				'options' 		=> [
					'normal'			=> 'Normal',
					'color'				=> 'Color',
		...
		// 	[
		// 		'label' => esc_html__( 'Transition Duration', 'master-addons' ),
		// 		'type' => Controls_Manager::SLIDER,
		// 		'range' => [
		// 			'px' => [
		// 				'step' => 100,
		...
		// 		],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .elementor-widget' => 'transition: all {{SIZE}}ms;',
		// 		],
		// 	]
		// );
		...
		// 		],
		// 		'selectors' => [
		// 			'{{WRAPPER}}:hover' => 'transition: all {{SIZE}}ms;',
		// 		],
		// 	]
		// );
