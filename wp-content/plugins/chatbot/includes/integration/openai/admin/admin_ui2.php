                ...
                <div class="card-body p-sm-0">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#wp-chatbot-openai-settings"><span class="wpwbot-admin-tab-icon "> <i class="fa fa-cogs"></i> </span><?php echo esc_html__('OpenAI settings', 'chatbot'); ?></a></li>
                        <li><a data-toggle="tab" href="#wp-chatbot-openai-training-model"><span class="wpwbot-admin-tab-icon "> <i class="fa fa-modx"></i> </span><?php echo esc_html__('Training Model', 'chatbot'); ?></a></li>
                        <li><a data-toggle="tab" href="#wp-chatbot-openai-assistants"><span class="wpwbot-admin-tab-icon "> <i class="fa fa-rocket"></i> </span><?php echo esc_html__('GPT Assistant', 'chatbot'); ?></a></li>
                        <li><a data-toggle="tab" href="#wp-chatbot-data_post_converter"><span class="wpwbot-admin-tab-icon "> <i class="fa fa-database"></i> </span><?php echo esc_html__('Fine Tune with Website Data', 'chatbot'); ?></a></li>
                        <li><a data-toggle="tab" href="#wp-chatbot-img_generator"><span class="wpwbot-admin-tab-icon "> <i class="fa fa-file-image-o"></i> </span><?php echo esc_html__('AI Image Generator', 'chatbot'); ?></a></li>
                        <li><a data-toggle="tab" href="#wp-chatbot-content_writer"><span class="wpwbot-admin-tab-icon "> <i class="fa fa-text-height"></i> </span><?php echo esc_html__('AI Article Generator', 'chatbot'); ?></a></li>
                        <li><a data-toggle="tab" href="#wp-chatbot-openai-help"><span class="wpwbot-admin-tab-icon "> <i class="fa fa-question-circle"></i> </span><?php echo esc_html__('Help', 'chatbot'); ?></a></li>
                    </ul>
