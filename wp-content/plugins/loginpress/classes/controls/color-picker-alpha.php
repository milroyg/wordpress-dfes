...
class LoginPress_Color_Picker_Alpha extends WP_Customize_Color_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'loginpress-color-picker-alpha', LOGINPRESS_DIR_URL . 'js/controls/loginpress-color-picker-alpha.js', array( 'customize-controls', 'jquery' ), LOGINPRESS_VERSION, true );
	}
