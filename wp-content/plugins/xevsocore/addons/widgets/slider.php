			...
			<?php foreach ($settings['xevso_sliders_two'] as $xevso_slider):
				...
				<div class="single-slider">
					<div class="image-layout"
						style="background-image:url( <?php echo esc_url(wp_get_attachment_image_url($xevso_slider['xevso_slider_two_img']['id'], 'full')); ?> )">
					</div>
					<div class="container">
						<div
							class=" justify-content-center <?php if ($xevso_slider['xevso_slider_video_position'] == '1'): ?>row<?php endif; ?>">
							<div class="col-lg-12">
								<div class="slider-content">
									<div class="sub-title"
										data-animation="<?php echo esc_attr($xevso_slider['xevso_slider_two_title_ani']); ?>"
										data-delay="<?php echo esc_attr($xevso_slider['xevso_slider_two_title_dtime']['size']); ?>s">
										<?php echo wp_kses_post($xevso_slider['xevso_slider_two_title']); ?></div>
									<div class="slider-dec"
										data-animation="<?php echo esc_attr($xevso_slider['xevso_slider_two_content_ani']); ?>"
										data-delay="<?php echo esc_attr($xevso_slider['xevso_slider_two_dec_dtime']['size']); ?>s">
										<?php echo wp_kses_post($xevso_slider['xevso_slider_two_content']); ?></div>
										...
										*/
										...
										<?php if ($xevso_slider['xevso_slider_video_position'] == '1'): ?>
											<div class="slider-video-btn"
												data-animation="<?php echo esc_attr($xevso_slider['xevso_slider_video_ani']); ?>"
												data-delay="<?php echo esc_attr($xevso_slider['xevso_slider_two_video_dtime']['size']); ?>s">
												<a href="<?php echo esc_url($xevso_slider['xevso_slider_video_link']); ?>"
													class="slider-video"
													aria-label="<?php echo esc_attr(!empty($xevso_slider['xevso_slider_video_text']) ? 'Play video: ' . $xevso_slider['xevso_slider_video_text'] : 'Play video'); ?>"
													tabindex="0">
							...
							<?php if ($xevso_slider['xevso_slider_video_position'] == '2'): ?>
								<div class="col-lg-3 d-flex flex-wrap align-content-center">
									<div class="slider-video-btn"
										data-animation="<?php echo esc_attr($xevso_slider['xevso_slider_video_ani']); ?>"
										data-delay="<?php echo esc_attr($xevso_slider['xevso_slider_two_video_dtime']['size']); ?>s">
										<a href="<?php echo esc_url($xevso_slider['xevso_slider_video_link']); ?>" class="slider-video"
											aria-label="<?php echo esc_attr(!empty($xevso_slider['xevso_slider_video_text']) ? 'Play video: ' . $xevso_slider['xevso_slider_video_text'] : 'Play video'); ?>"
											tabindex="0">
											<i class="fa fa-play" aria-hidden="false"></i>
										</a>
