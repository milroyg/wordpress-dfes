 ...
 * @since 1.0.0
 */
class xevso_blogtwo_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Blog Two', 'xevsocore' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'xevso_blog_styles',
            [
                'label' => esc_html__( 'Top Area', 'xevsocore' ),
	...
	<div class="blog-boxs blog-post">
		<div class="blog-box">
            <div class="blog-items row blog_area_two">
		        <?php
                global $post;
                $count = 0;
                ...
                <div class="item <?php if ( $settings['xevso_blog_style'] == '2' ): ?>col-12 col-md-6 <?php if ( $count == 1 ): ?>col-lg-7 <?php else: ?>col-lg-5 col-xl-5<?php endif;?><?php else: ?>col-12 col-md-6 col-lg-<?php echo esc_attr($settings['xevso_blog_column']); ?><?php endif;?>">
                    <div id="post-<?php the_ID();?>" <?php post_class( 'post-single' );?>>
                        ...
                        <div class="blog-conten-tow">
								<div class="blog-contents_inner">
                            <div class="blog-top">
                        <ul>
                        <li class="postby"><?php xevso_posted_by();?></li>
                            ...
                            <div class="blog-footer">
                                ...
                                <div class="right">
                                    <div class="blog-comment-num">
                                        <?php comments_popup_link( '0', '1', '% ' . esc_html__( 'Comments', 'xevsocore' ) . '' );?>
                                    </div>
                                </div>
                            </div>
							 </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new xevso_blogtwo_Widget );