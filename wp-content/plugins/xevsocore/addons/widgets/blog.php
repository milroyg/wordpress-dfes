 ...
 * @since 1.0.0
 */
class xevso_blog_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'xevso Blog', 'xevsocore' );
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new xevso_blog_Widget );