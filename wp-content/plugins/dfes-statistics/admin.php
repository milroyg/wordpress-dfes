...
<div class="wrap">
  ...
  <div class="notice notice-info" style="padding:15px; margin-bottom:20px;">
    ...
    <button id="delete-uploaded-csv" class="button button-secondary"
            style="margin-left:10px;">🗑️ Remove
    </button>
  </div>
  <?php endif; ?>
  ...
  <div class="card" style="padding:20px; margin-top:20px; max-width:800px;">
    ...
    <div style="margin:15px 0;">
      <a
        href="https://docs.google.com/spreadsheets/d/1SLO1O_1T2HtMTEIFhcTJC6vEZj6frf13zUMkmnYb3EU/edit?gid=1007388713#gid=1007388713"
        target="_blank"
    ...
    <form method="post" style="margin-top:15px;">
      ...
      <input type="submit" name="refresh_google_csv"
             class="button button-primary" value="🔄 Refresh Google Sheet CSV"/>
    </form>
...
<script>
  jQuery(document).ready(function ($) {
    ...
    $('#delete-uploaded-csv').click(function (e) {
      e.preventDefault();
      if (!confirm('Are you sure you want to delete the uploaded CSV file?')) {
        return;
      }
