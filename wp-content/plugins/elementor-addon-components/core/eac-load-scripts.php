...
class Eac_Load_Scripts {
	...
	public function __construct() {
		/** Ajout des shortcodes, Templates Elementor, ACF image gallery... */
	...
	public function add_columns( $columns ) {
		...
		if ( class_exists( SiteHeader::class, false ) && ! empty( get_query_var( Source_Local::TAXONOMY_TYPE_SLUG ) ) && ( SiteHeader::TYPE === get_query_var( Source_Local::TAXONOMY_TYPE_SLUG ) || SiteFooter::TYPE === get_query_var( Source_Local::TAXONOMY_TYPE_SLUG ) ) ) {
