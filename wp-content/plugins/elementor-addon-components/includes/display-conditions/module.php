...
use EACCustomWidgets\Includes\DisplayConditions\Controller;
...
class Module {
	...
	public function __construct() {
		add_action( 'elementor/element/after_section_end', array( $this, 'inject_controls' ), 9999, 2 );
		/**add_action( 'elementor/element/section/_section_responsive/after_section_end', array( $this, 'inject_controls' ), 10 );
		add_action( 'elementor/element/column/_section_responsive/after_section_end', array( $this, 'inject_controls' ), 10 );
		add_action( 'elementor/element/common/_section_responsive/after_section_end', array( $this, 'inject_controls' ), 10 );*/
		...
		$element->start_controls_section(
			...
			$element->add_responsive_control(
				...
				array(
					...
					'label_block'    => true,
					'separator'      => 'before',
					'selectors'      => array( '.element-condition_fallback-{{ID}}' => 'inline-size: {{SIZE}}{{UNIT}};' ),
					'condition'      => array(
						'element_condition_active' => 'yes',
						'element_condition_fallback_active' => 'yes',
					),
			...
			$element->add_responsive_control(
				...
				array(
					...
					'label_block' => true,
					'selectors'   => array( '.element-condition_fallback-{{ID}}' => 'min-block-size: {{SIZE}}px;' ),
					'condition'   => array(
						'element_condition_active' => 'yes',
						'element_condition_fallback_active' => 'yes',
					),
			...
			$element->add_control(
				...
				array(
					...
					'selectors'          => array(
						'.element-condition_fallback-{{ID}}' => 'margin-block: {{TOP}}px {{BOTTOM}}px;',
					),
					'condition'          => array(
						'element_condition_active' => 'yes',
						'element_condition_fallback_active' => 'yes',
			...
			$element->add_responsive_control(
				...
				array(
					...
					'default'   => 'center',
					'selectors' => array(
						'.element-condition_fallback-{{ID}} div' => 'margin-inline: {{VALUE}};',
					),
					'condition' => array(
						'element_condition_active' => 'yes',
						'element_condition_fallback_active' => 'yes',
