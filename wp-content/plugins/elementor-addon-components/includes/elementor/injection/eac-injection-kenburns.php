...
class Eac_Injection_Kenburns {
	...
	public function __construct() {
		add_action( 'elementor/element/section/section_background_overlay/after_section_end', array( $this, 'inject_section' ), 10, 1 );
		add_action( 'elementor/element/container/section_background_overlay/after_section_end', array( $this, 'inject_section' ), 10, 1 );
		add_action( 'elementor/element/column/section_border/before_section_start', array( $this, 'inject_section' ), 10, 1 );
		...
		add_action( 'elementor/frontend/after_enqueue_scripts', array( $this, 'enqueue_scripts' ), 14 );
	}
	 ...
	 */
	public function inject_section( $element ) {
