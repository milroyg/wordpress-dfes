...
class Eac_Injection_Image {
	...
	public function __construct() {
		...
		add_action( 'elementor/element/eac-addon-modal-box/mb_param_trigger/before_section_end', array( $this, 'add_modalbox_custom_injection' ), 10, 1 );
		add_action( 'elementor/element/image-box/section_image/before_section_end', array( $this, 'add_image_custom_injection' ), 10, 1 );
	 ...
	 */
	public function add_modalbox_custom_injection( $element ) {
	 ...
	 * @param array        $args Section arguments.
	 */
	public function add_image_custom_injection( $element ) {
