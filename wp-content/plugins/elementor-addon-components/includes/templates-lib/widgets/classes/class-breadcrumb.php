...
class Class_Breadcrumb {
	...
	/**
	 * Sets up the breadcrumb trail properties.  Calls the `Class_Breadcrumb::add_items()` method
	 ...
	 *     @type array     $labels           Text labels. @see Class_Breadcrumb::set_labels()
	 *     @type array     $post_taxonomy    Taxonomies to use for post types. @see Class_Breadcrumb::set_post_taxonomy()
	...
	public function trail() {
		...
		if ( 0 < $item_count ) {
			...
			$breadcrumb .= sprintf( '</%s></div>', tag_escape( $this->args['list_tag'] ) );
		}
...
/**
 * Shows a breadcrumb for all types of pages. This is a wrapper function for the Class_Breadcrumb class,
 * which should be used in theme templates.
 *
 * @access public
 * @param array $args Arguments to pass to Class_Breadcrumb.
 * @return void
 */
/**function Class_Breadcrumb( $args = array() ) {

	if ( ! empty( $args ) ) {
		$breadcrumb = new Class_Breadcrumb( $args );
	} else {
		$breadcrumb = new Class_Breadcrumb();
	}
