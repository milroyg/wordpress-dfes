...
class Site_Copyright_Widget extends Widget_Base {
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				array(
					...
					'default'   => 'center',
					'toggle'    => false,
					'selectors' => array( '{{WRAPPER}} .eac-copyright-wrapper' => 'text-align: {{VALUE}};' ),
				)
			);
	...
	protected function render() {
		...
		<div class='eac-copyright-wrapper'>
			<?php if ( ! empty( $link ) ) { ?>
				<a <?php $this->print_render_attribute_string( 'sc-link-to' ); ?>>
					<span dir='ltr'><?php echo wp_kses_post( $copyright_shortcode ); ?></span>
				</a>
			<?php } else { ?>
				<span dir='ltr'><?php echo wp_kses_post( $copyright_shortcode ); ?></span>
			<?php } ?>
