...
class Modal_Box_Widget extends Widget_Base {
	...
	protected function render_modal() {
		...
		if ( 'button' === $trigger ) {
			...
			$this->add_render_attribute( 'trigger', 'alt', esc_attr( $image_alt ) );
			...
			$this->add_render_attribute( 'trigger', 'title', esc_attr( $settings['mb_display_texte'] ) );
		}
