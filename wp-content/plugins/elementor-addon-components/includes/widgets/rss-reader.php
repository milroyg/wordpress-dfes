<?php
/**
 * Class: Rss_Reader_Widget
 * Name: Lecteur RSS
 * Slug: eac-addon-lecteur-rss
 *
 * Description: Rss_Reader_Widget affiche une liste de médias
...
class Rss_Reader_Widget extends Widget_Base {
			...
			$this->add_control(
				...
				array(
					...
					'default'     => array(
						...
						array(
							'rss_item_title' => 'Youtube Channel - France Musique',
							'rss_item_url'   => array( 'url' => 'https://www.youtube.com/feeds/videos.xml?channel_id=UCiPYZkZeNbYTQZKNMlB0Gsw' ),
						),
						array(
							'rss_item_title' => 'Youtube Channel - FIP',
							'rss_item_url'   => array( 'url' => 'https://www.youtube.com/feeds/videos.xml?channel_id=UCFLkFeQEuU9CHQISq_rp0_Q' ),
						),
						array(
	...
	protected function render_galerie() {
		...
		<div class='rss-select__item-list'>
			...
			$this->add_render_attribute( 'read_button', 'id', 'rss__read-button' );
