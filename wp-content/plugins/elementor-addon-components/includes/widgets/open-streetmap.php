...
class Open_Streetmap_Widget extends Widget_Base {
	...
	protected function render_map() {
		...
		$this->add_render_attribute( 'osm_marker', 'data-lat', esc_attr( $center_lat ) );
		$this->add_render_attribute( 'osm_marker', 'data-lng', esc_attr( $center_lng ) );
		?>
				...
				if ( ! empty( $marker['osm_markers_tooltip_lat'] ) && ! empty( $marker['osm_markers_tooltip_lng'] ) ) {
					...
					$this->add_render_attribute(
						...
						array(
							...
							'data-lat'   => esc_attr( $marker['osm_markers_tooltip_lat'] ),
							'data-lng'   => esc_attr( $marker['osm_markers_tooltip_lng'] ),
