	...
	<table class='widefat' cellspacing='0'>
		...
		<tbody>
			<tr>
				...
				<td><?php $etat_active ? printf( '%s ( version: %s )', esc_html__( 'Oui', 'eac-components' ), esc_html( $etat['version'] ) ) : esc_html_e( 'Non', 'eac-components' ); ?></td>
			</tr>
			<?php if ( $etat_active ) : ?>
				<tr>
					<td><?php esc_html_e( 'Redémarrage du cache', 'eac-components' ); ?></td>
					<td><?php echo esc_html( $etat['last_restart'] ); ?></td>
				</tr>
				<tr>
					<td><?php esc_html_e( 'Vérifie horodatage des scripts', 'eac-components' ); ?></td>
					<td><?php 0 === absint( $etat['timestamp'] ) ? esc_html_e( 'Non', 'eac-components' ) : esc_html_e( 'À chaque requête', 'eac-components' ); ?></td>
				</tr>
				<tr>
					<td><?php esc_html_e( 'Fréquence de mise à jour des scripts', 'eac-components' ); ?></td>
					<td><?php echo esc_html( $etat['freq'] ) . 's'; ?></td>
				</tr>
				<tr>
					<td><?php esc_html_e( 'Nombre max de scripts', 'eac-components' ); ?></td>
					<td><?php echo esc_html( $etat['max_scripts'] ); ?></td>
				</tr>
				<tr>
					<td><?php esc_html_e( 'Nombre total de scripts', 'eac-components' ); ?></td>
					<td><?php echo esc_html( $etat['total_scripts'] ); ?></td>
				</tr>
				<tr>
					<td><?php esc_html_e( 'Scripts pas dans le cache', 'eac-components' ); ?></td>
					<td><?php echo esc_html( $etat['misses_scripts'] ); ?></td>
				</tr>
				<tr>
					<td><?php esc_html_e( 'EAC Nombre de scripts', 'eac-components' ); ?></td>
					<td><?php echo esc_html( $etat['eac_scripts'] ); ?></td>
				</tr>
				<tr>
					<td><?php esc_html_e( 'Mémoire allouée', 'eac-components' ); ?></td>
					<td><?php echo esc_html( $etat['allocated_memory'] ); ?></td>
				</tr>
				<tr>
					<td><?php esc_html_e( 'Mémoire utilisée', 'eac-components' ); ?></td>
					<td><?php echo esc_html( $etat['used_memory'] ); ?></td>
				</tr>
				<tr>
					<td><?php esc_html_e( 'Mémoire libre', 'eac-components' ); ?></td>
					<td><?php echo esc_html( $etat['free_memory'] ); ?></td>
				</tr>
				<tr>
					<td><?php esc_html_e( 'Compilation jit', 'eac-components' ); ?></td>
