 ...
 * Description: Fetches data from the Goa Fire Department GPS API and saves it to a GeoJSON file.
 * Version: 1.0
 * Author: Junie
 */
...
class DFES_Fire_Appliances_API {
    ...
    public function __construct() {
        ...
        add_action('dfes_fire_appliances_cron_event', [$this, 'fetch_and_cache_data']);
        ...
        if (is_admin()) {
            ...
            add_action('admin_post_dfes_refresh_data', [$this, 'handle_manual_refresh']);
        }
    }
    ...
    public function admin_page() {
        ...
        <div class="wrap">
            ...
            <p>This plugin fetches fire truck data and saves it to the WordPress database.</p>
            <p><strong>Fixed URL:</strong> <a href="<?php echo home_url('/goa-fire-trucks.geojson'); ?>" target="_blank"><?php echo home_url('/goa-fire-trucks.geojson'); ?></a></p>
