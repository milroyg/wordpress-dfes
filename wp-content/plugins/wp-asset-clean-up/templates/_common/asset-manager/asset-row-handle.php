    ...
    <div class="wpacu_handle">
        ...
        if ($assetType === 'styles') {
            if ($data['row']['obj']->handle === 'wp-block-library') {
                ?>
                &#10230; <span style="color: #ccc;" class="dashicons dashicons-text-page"></span> <a href="https://www.assetcleanup.com/docs/?p=713" target="_blank" rel="noopener noreferrer">Read more</a>
                <?php
            }
        } elseif ($assetType === 'scripts') {
            if ($data['row']['obj']->handle === 'swiper') {
                ?>
                &#10230; <span style="color: #ccc;" class="dashicons dashicons-text-page"></span> <a href="https://www.assetcleanup.com/docs/?p=737" target="_blank" rel="noopener noreferrer">Read more</a>
                <?php
            }
        }
        ...
        require WPACU_PLUGIN_DIR . '/templates/_common/asset-manager/asset-row-location-status.php';
        ?>
    </div>
<?php
