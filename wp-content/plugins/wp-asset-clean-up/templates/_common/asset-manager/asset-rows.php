...
foreach ($assetTypes as $assetType) {
    ...
    foreach ($allAssets as $obj) {
        ...
        */
        ...
        $isUnloadRegExMatch = false;
        $isLoadExceptionRegExMatch = false;
        $isLoadExceptionForCurrentPostViaTax = false;
        $isLoadExceptionForCurrentTaxType = false;
        $isLoadExceptionAuthorType = false;
    ...
    foreach ($allAssetsFinal as $assetHandle => $row) {
        ...
        if (isset($data['rows_by_location']) && $data['rows_by_location']) {
            ...
            $handlePosition = defined('WPACU_PRO_PLUGIN_VERSION') && isset($row['obj']->position_new) && $row['obj']->position_new
                ? $row['obj']->position_new
                : $row['obj']->position;
